      ...
      <div className="flex flex-col gap-8 lg:flex-row">
        ...
        <div className="flex flex-col gap-8 justify-center">
          ...
          <p>
            ...
            d'explorer les bases matérielles, j'ai poursuivi avec un DUT Réseaux
            & Télécoms pour{' '}
            <strong>
            ...
            <strong>
              ce parcours transversal pour concevoir, développer et déployer des
              solutions web avec une vision globale des systèmes
            </strong>
            .
          </p>
